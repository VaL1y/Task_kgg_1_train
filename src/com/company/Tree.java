...
public class Tree {
    ...
    public Tree(final int x, final int y, final int width, final int height, final Color color, final Color colorCr, final int radius) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    void draw(final Graphics gr) {
        ...
        g.fillRect((this.x / 2) - 10, this.y / 2 - 30, this.width, this.height / 2);
        g.setColor(colorCr);
